...
Plans:
- [x] 03-01-PLAN.md — Backend: parties table + WhatsApp service + notification API endpoints + config status
- [x] 03-02-PLAN.md — Frontend: integrate arrival + dispatch notifications into CreateLot and InProcessCard
